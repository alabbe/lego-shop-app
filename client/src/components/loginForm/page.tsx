...
const LoginForm = ({ onSubmit, onChange, formData, message }: { onSubmit: FormEventHandler, onChange: FormEventHandler, formData: LoginFormPayload, message: string }) => {
  ...
  return (
    <div className='flex flex-col mx-4 my-8 gap-4 p-5'>
      ...
      <div><p className='text-red-600'>{message}</p></div>
